  ...
  return (
    <div className="float-child-1-top" id="sideNavTop">
      ...
      <div className="questionSummary">
        ...
        <FormatText count={props.counts.visitedQuestionsCount-props.counts.answeredQuestionsCount}/>
        </div>
        <div className="notAnsweredQuestionsText">Not Answered</div>
      </div>
      <div className="questionSummary">
        <div className="notVisited">
        <FormatText count={props.counts.totalQuestionsCount-props.counts.visitedQuestionsCount}/>
        </div>
